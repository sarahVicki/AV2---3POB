...
public class CrudQuarto {
    ...
    public void incluirQuarto (int id, String nomeQuarto, int qtdeCamas, boolean temBanheiro, String descricao) {
    ...
    public void alterarQuarto (int id, String nomeQuarto, int qtdeCamas, boolean temBanheiro, String descricao) {
